...
public class FakePizzaDbService : IPizzaService
{
    private List<Pizza> _pizzas = new List<Pizza>()
    {
        new Pizza
        {
            Id = 1, Name = "Bacon", Price = 12, Ingredients = new List<Ingredient>()
            {
        ...
        new Pizza
        {
            Id = 2, Name = "4 fromages", Price = 11, Ingredients = new List<Ingredient>()
            {
        ...
        new Pizza
        {
            Id = 3, Name = "Margherita", Price = 10, Ingredients = new List<Ingredient>()
            {
        ...
        new Pizza
        {
            Id = 4, Name = "Mexicaine", Price = 12, Ingredients = new List<Ingredient>()
            {
        ...
        new Pizza
        {
            Id = 5, Name = "Reine", Price = 11, Ingredients = new List<Ingredient>()
            {
        ...
        new Pizza
        {
            Id = 6, Name = "Pepperoni", Price = 11, Ingredients = new List<Ingredient>()
            {
        ...
        new Pizza
        {
            Id = 7, Name = "Végétarienne", Price = 10, Ingredients = new List<Ingredient>()
            {
